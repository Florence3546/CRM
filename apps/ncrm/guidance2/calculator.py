...
from apps.ncrm.models import (Subscribe, Customer, PSUser, Contact, ReIntro, Comment,
                              Unsubscribe, event_coll, ARTICLE_CODE_CHOICES)
...
class ViewerFactory(object):
    ...
    def show_subscribe(cls, order_id_list, shop_id_list):
        ...
        for obj in objs:
            data_list.append([obj.psuser_id and psuser_dict[obj.psuser_id],
    ...
    def show_contact(cls, contact_id_list, shop_id_list):
        ...
        data_list = [title_list]
        for obj in objs:
            data_list.append([obj.create_time.strftime('%Y-%m-%d %H:%M'),
