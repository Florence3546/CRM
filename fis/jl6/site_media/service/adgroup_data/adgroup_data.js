define(['require', '../common/top_bar_event', '../common/common', "template", "../keyword/keyword", "moment","pin", "jslider","widget/selectSort/selectSort"], function(require, topBarEvent, common, template, keywordManage,moment,pin) {
    "use strict"
    ...
    var layoutKeywordList=function(data){
        ...
        KM = new keywordManage.Table({
            ...
            warnPrice: Number($('#warn_price span').text()),
            mobileWarnPrice: Number($('#mobile_warn_price span').text()),
            headerMarginTop:50,
