...
(function($) {
    ...
    $.fn.treeview = function(settings) {
        var dfop =
            {
                 ...
                 */
                cbiconpath: "/site_media/js/tree_css/images/icons/",
        ...
        me[0].t = {
        	check_all: function(){
        		var s = [];
                getCkAndHalfCk(treenodes, s, function(item) { return check(item,1,1); });
                return s;
            },
        	uncheck_all: function(){
        		var s = [];
                getCkAndHalfCk(treenodes, s, function(item) { return check(item,0,1); });
                return s;
            },
    ...
    $.fn.uncheck_all = function(){
    	if (this[0].t) {
    		this[0].t.uncheck_all();
    	}
    };
