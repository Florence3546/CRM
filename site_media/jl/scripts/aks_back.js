 ...
 */
PT.namespace('aks');
PT.aks.base_src=("https:"==document.location.protocol?"https://":"http://")+'suggest.taobao.com/sug?extras=1&code=utf-8&q=';
...
PT.aks.start=function(){
	...
	PT.sendDajax({'function':'web_get_spider_list'});
}
...
//			sendData+='"'+k+'":['+this.data_arr[i][k]+'],';
	...
	PT.sendDajax({'function':'web_get_spider_result','data':$.toJSON(sendData)});
}