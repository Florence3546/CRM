...
(function(root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define('jl6/site_media/plugins/bootstrap-daterangepicker/daterangepicker', ['jl6/site_media/plugins/bootstrap-daterangepicker/moment', 'jl6/site_media/plugins/jquery/jquery.min', 'exports'], function(momentjs, $, exports) {
      root.daterangepicker = factory(root, exports, momentjs, $);
    });

  } else if (typeof exports !== 'undefined') {
    var momentjs = require('jl6/site_media/plugins/bootstrap-daterangepicker/moment');
    var jQuery = window.jQuery;
    if (jQuery === undefined) {
      try {
        jQuery = require('jl6/site_media/plugins/jquery/jquery.min');
      } catch (err) {
