...
(function( factory ) {
        ...
        {
                define('jl6/site_media/plugins/data-tables/dataTables.1.1.0',  ['jl6/site_media/plugins/jquery/jquery.min'], factory );
        }
...
$.fn.dataTableExt.afnSortData['custom-text']=function(oSettings,iColumn){return $.map(oSettings.oApi._fnGetTrNodes(oSettings),function(tr,i){var td=oSettings.oApi._fnGetTdNodes(oSettings,i)[iColumn];if(tr.className.indexOf('unsort')!=-1){return 'unsort'}else{return $(td).find("span:first").hasClass('custom')?Number($(td).find('span:first').text()):$(td).text();}})};
$.fn.dataTableExt.afnSortData['dom-input']=function(oSettings,iColumn){return $.map(oSettings.oApi._fnGetTrNodes(oSettings),function(tr,i){return $('td:eq('+iColumn+') input',tr).val();});};
$.fn.dataTableExt.oSort['custom-asc']=function(x,y){if(x=="unsort")return-1;if(y=="unsort")return 1;x=parseFloat(x);y=parseFloat(y);return((x<y)?-1:((x>y)?1:0))};
$.fn.dataTableExt.oSort['custom-desc']=function(x,y){if(x=="unsort")return-1;if(y=="unsort")return 1;x=parseFloat(x);y=parseFloat(y);return((x<y)?1:((x>y)?-1:0))};
$.fn.dataTableExt.afnSortData['dom-text']=function(oSettings,iColumn){return $.map(oSettings.oApi._fnGetTrNodes(oSettings),function(tr,i){return $('td:eq('+iColumn+') span:eq(0)',tr).text()})};
$.fn.dataTableExt.afnSortData['td-text']=function(oSettings,iColumn){return $.map(oSettings.oApi._fnGetTrNodes(oSettings),function(tr,i){return $('td:eq('+iColumn+')',tr).text()})};
$.fn.dataTableExt.afnSortData['dom-checkbox']=function(oSettings,iColumn){return $.map(oSettings.oApi._fnGetTrNodes(oSettings),function(tr,i){return $('td:eq('+iColumn+') input',tr).prop('checked')?'1':'0'})};
$.fn.dataTableExt.afnSortData['custom-span'] = function(oSettings, iColumn) {return $.map(oSettings.oApi._fnGetTrNodes(oSettings), function(tr, i) {return $('td:eq(' + iColumn + ')>span:first', tr).text() }) };