...
(function( factory ) {
	...
	{
		define('jl6/site_media/plugins/data-tables/jquery.dataTables',  ['jl6/site_media/plugins/jquery/jquery.min'], factory );
	}
...
$.fn.dataTableExt.afnSortData['custom-text']=function(oSettings,iColumn){
	return $.map(oSettings.oApi._fnGetTrNodes(oSettings),function(tr,i){
		...
		if(tr.className.indexOf('unsort')!=-1){
			...
			return td.className.indexOf('custom')!=-1?$(td).find('span:first').text():$(td).text();
		}
	})
};
...
jQuery.fn.dataTableExt.oSort['custom-asc']=function(x,y){
	if(x=="unsort")return-1;
	if(y=="unsort")return 1;
	x=parseFloat(x);
	y=parseFloat(y);
	return((x<y)?-1:((x>y)?1:0))
};
...
$.fn.dataTableExt.afnSortData['dom-text']=function(oSettings,iColumn){
	return $.map(oSettings.oApi._fnGetTrNodes(oSettings),function(tr,i){
		return $('td:eq('+iColumn+') span:eq(0)',tr).text()
	})
};
$.fn.dataTableExt.afnSortData['td-text']=function(oSettings,iColumn){
    return $.map(oSettings.oApi._fnGetTrNodes(oSettings),function(tr,i){
