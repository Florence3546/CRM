...
var TableTools;
define('site_media/plugins/data-tables/TableTools', ['require', "site_media/plugins/data-tables/dataTables.min", "site_media/plugins/data-tables/ZeroClipboard"], function(require) {
...
TableTools.prototype = {
	...
	"_fnCustomiseSettings": function ( oOpts )
	{
		...
		this.s.custom_btn_id=this.s.custom.custom_btn_id;
	...
	"_fnFlashGlue": function ( flash, node, text )
	{
		...
		if(this.s["custom_btn_id"]&&this.s["custom_btn_id"]!=''){
			node=document.getElementById(this.s["custom_btn_id"]);
		}
		if(node&&node.btn_id){
			node=document.getElementById(node.btn_id);
		}
		if ( node )
		{
	 ...
	 *
	 * This function is required for large informatioln sets. There is a limit on the
